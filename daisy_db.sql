...
--
-- Host: localhost
-- Erstellungszeit: 21. Sep 2015 um 21:03
...
(1, 'http://localhost/teamproject', '127.0.0.1');
...
INSERT INTO `file_uploads` (`id`, `user_id`, `group_id`, `src`, `filename`, `type`, `created`, `modified`) VALUES
...
(11, 'Wolfram Alpha', NULL, NULL, 'wolframalpha.com', '/img/tools/wolframalpha.jpg', '<h2>WolframAlpha</h2>               <ul>                 <li>Rechen- und Wissensanwendung</li>                 <li>Loest mathematische Probleme.</li>               </ul>', NULL, 0),

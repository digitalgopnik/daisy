...
<section id="container">
    <header class="header black-bg">
        ...
        <a href="https://www.tu-braunschweig.de/" target='_blank' class="logo"><img id='logo' style="margin-left: -15px;height: 60px;" alt="TU Braunschweig" src="http://dashy.wi2.phil.tu-bs.de/img/TUBraunschweig_SC.png"></a>
        <!--logo end-->
